...
public class gift
{
	...
	void v1()
	{
		...
		for(Map.Entry<String,Integer> ee:tm.entrySet())
		{
			System.out.println("Sweet name: "+ee.getKey()+" Sweet Weight: "+ee.getValue());
		}
		for(Map.Entry<String,Integer> ee:tmap.entrySet())
		{
			System.out.println("Sweet name: "+ee.getKey()+" Sweet Price: "+ee.getValue());
		}
	}
void v2()
{
